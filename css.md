...
```css
/*To add padding  */
padding: number of pixles(px);

/*To add margin */
margin: number of pixles(px);

/*To add border */
border: number of pixles(px) color;
```
...
font-size: number of pixles(px);

/*To change the font family  */
font-family: "Times New Roman", Times, serif;

/*To change the font width */
font-weight: number of pixles(px);
```
...
```css
/*To change width */
width: number of pixles(px);

/*To change height  */
height: number of pixles(px);
```
